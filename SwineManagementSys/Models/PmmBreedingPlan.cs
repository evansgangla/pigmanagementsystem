...
{
    public partial class PmmBreedingPlan
    {
        ...
        public string? BpPregnancyTest { get; set; }
        public string? BpPregnancyTicket { get; set; }
        public string? BpConceptionRate { get; set; }
        public string? BpBreedingTicket { get; set; }
        public string? BpFarrowDt { get; set; }
        public string? BpLitterId { get; set; }
        public string? BpLitterMass { get; set; }
        public string? BpReturnsRate { get; set; }
    }
}
